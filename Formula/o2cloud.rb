class O2cloud < Formula
  include Language::Python::Virtualenv

  desc "Scriptable, agent-friendly CLI for O2 Cloud"
  homepage "https://github.com/dbaratech/o2cloud"
  url "https://files.pythonhosted.org/packages/4e/51/118d0b7d3cffb63fe1115d8d9545cd46c6caa0d06781e6465e9d47470b45/o2cloud-0.4.0.tar.gz"
  ...
  test do
    assert_match "o2cloud #{version}", shell_output("#{bin}/o2cloud --version")
  end
end
